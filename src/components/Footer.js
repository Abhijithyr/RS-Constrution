    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-logo-info">
          <img src={logo} alt="Company Logo" className="footer-logo" loading="lazy" />
          <p className="footer-description">
            R S Construction - You dream it, we will build it. Building your
        ...
        <div className="footer-navigation">
          ...
          <a href="/cost-estimator">Cost Estimator</a>
        ...
        <div className="footer-contact">
          ...
          <p>
            Phone:
            <span className="footer_no_span"> +91 9916477467</span>
          </p>
          <p>Email: rsconstruction.kar@gmail.com</p>
          <p>
            Address: Kengeri, Bengaluru, Karnataka-
            <span className="footer_no_span">560060,</span> India
          </p>
        </div>

        <div className="footer-social">
          <h3>Follow Us</h3>
          <a href="https://www.facebook.com/share/16TGXBAKkX/" rel="noreferrer" target="_blank" aria-label="Facebook">
            <svg
          ...
          <a href="https://www.instagram.com/rsconstruction.kar?igsh=MzU1cHIxZzVhNGph" rel="noreferrer" target="_blank" aria-label="Instagram">
            <svg
              viewBox="64 64 896 896"
              width="1em"
              height="1em"
      ...
      <div className="footer-bottom">
        <p>© {currentYear} R S Construction. All rights reserved.</p>
      </div>
    </footer>
  );
};
